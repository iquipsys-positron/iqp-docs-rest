...
Creates new zone from json string for specified site. The coordinates format depends on zone type, make sure that you use correct format for coordinates array using GeoJSON.
